...
class SyncManPlugin(InterfaceActionBase):
    '''
    ...
    '''
    name                = 'SyncMan'
    description         = 'Manage synchronizing applications'
    ...
    actual_plugin       = 'calibre_plugins.syncman.action:SyncManAction'
